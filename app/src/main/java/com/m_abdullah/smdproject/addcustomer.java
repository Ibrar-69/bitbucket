...
public class addcustomer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cnic = findViewById(R.id.ac_cnic);
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(addcustomer.this, android.R.layout.simple_list_item_1, getResources().getStringArray(R.array.types));
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent it = new Intent(addcustomer.this, viewcustomer.class);
                it.putExtra("Name",name.getText().toString());
                it.putExtra("Email",email.getText().toString());
                it.putExtra("Cnic",cnic.getText().toString());
